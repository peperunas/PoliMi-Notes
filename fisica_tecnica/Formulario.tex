...
\item $\Delta S\geq0$ se il sistema è isolato;
\end{itemize}
...
\includegraphics[width=0.5\linewidth,height=0.25\paperheight,keepaspectratio]{Formulario/OttoPV}\includegraphics[width=0.5\linewidth,height=0.25\paperheight,keepaspectratio]{Formulario/OttoTS}
\begin{itemize}
...
\end{itemize}
\includegraphics[width=0.5\linewidth,height=0.25\paperheight,keepaspectratio]{Formulario/6894054_orig}\includegraphics[width=0.5\linewidth,height=0.25\paperheight,keepaspectratio]{Formulario/RankineComp}


\paragraph{Rankine con risurriscaldamento}
...
\item [{Viscosità}] $\mu=[Pl]$, indipendente dalla pressione;
...
\caption{Gas e calore specifico \label{tab:Specifiche-calore-specifico}}
...
\begin{table}[p]
\caption{Trasformazioni politropiche \label{tab:Trasformazioni-Politropiche}}
...
\caption{Conduzione - Coordinate cartesiane \label{tab:Conduzione---CoordinateCartesiane}}
...
\caption{Conduzione - Coordinate cilindriche \label{tab:Conduzione---CoordinateCilindriche}}
...
\caption{Conduzione - Coordinate sferiche \label{tab:Conduzione---CoordinateSferiche}}
...
\caption{Convezione - Costanti adimensionali \label{tab:Convezione---Costanti}}
...
\caption{Convezione - Condizioni di regime \label{tab:Convezione---Condizioni}}
...
\end{table}
\begin{table}[p]
\caption{Irragiamento - Calore\label{tab:Irragiamento}}
