...
\item $R_{IRR}=\varepsilon\sigma(T_{supp}^{2}+T_{amb}^{2})(T_{supp}+T_{amb})=\frac{1}{h_{irr}\cdot A}$
\end{itemize}
...
\hline 
Forma Sfera & $T$ & $R$ & $Superficie$\tabularnewline
\hline 
\hline 
Piena o cava & $-\frac{\sigma}{6k}r^{2}+\frac{A}{r}+B$ & $\frac{r_{2}-r_{1}}{4\pi r_{1}r_{2}k}$ & $4\pi r^{2}$\tabularnewline
\hline 
\end{tabular}
\end{table}
